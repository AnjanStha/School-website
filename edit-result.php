...
<input type='number' name="marks[]" class="form-control" id="marks" min="0" max="100" value=" <?php echo htmlentities($result->marks)?>" maxlength="3" required="required" placeholder="Enter marks out of 100" autocomplete="off">
