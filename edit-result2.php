...
$sql="update tblresult2  set marks2=:mrks where id=:iid ";
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css2animate-css/animate.min.css" media="screen" >
        ...
        <link rel="stylesheet" href="css2/select2/select2.min.css" >
...
$ret = "SELECT tblstudents.StudentName,tblclasses.ClassName,tblclasses.Section from tblresult2 join tblstudents on tblstudents.StudentId=tblresult2.StudentId join tblsubjects on tblsubjects.id=tblresult2.SubjectId join tblclasses on tblclasses.id=tblresult2.ClassId where tblstudents.StudentId=:stid limit 1";
...
<?php 
$sql = "SELECT distinct tblstudents.StudentName,tblstudents.StudentId,tblclasses.ClassName,tblclasses.Section,tblsubjects.SubjectName,tblresult2.marks2,tblresult2.id as resultid from tblresult2 join tblstudents on tblstudents.StudentId=tblresult2.StudentId join tblsubjects on tblsubjects.id=tblresult2.SubjectId join tblclasses on tblclasses.id=tblresult2.ClassId where tblstudents.StudentId=:stid ";
$query = $dbh->prepare($sql);
...
<input type='number' name="marks2[]" class="form-control" id="marks" min="0" max="25" value=" <?php echo htmlentities($result->marks2)?>" maxlength="2" required="required" placeholder="Enter marks out of 25" autocomplete="off">
