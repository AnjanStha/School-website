                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2><center> Mid Term Result</center></h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
// Code for result
 ...
 $query ="select t.StudentName,t.RollId,t.ClassId,t.marks1,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.RollId,sts.ClassId,tr.marks1,SubjectId from tblstudents as sts join  tblresult1 as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.RollId=:rollid and t.ClassId=:classid)";
...
foreach($results as $result){
    ...
    ?>
                                                ...
                                                <th scope="row"><?php echo htmlentities($cnt);?></th>
                                                			...
                                                			<td><?php echo htmlentities($totalmarks=$result->marks1);
															if($totalmarks<32) $check=0; ?></td>
                                                		</tr>
<?php 
$result=$marks1;
...
?>
<tr>
                                                <th scope="row" colspan="2">TotalMarks</th>
...
</tr><th scope="row" colspan="2">Result</th>           
...
<tr>
                                                <th scope="row" colspan="2">Download Result</th>           
                                                            <td><b><a href="download-result1.php">Download </a> </b></td>
                                                             </tr>
