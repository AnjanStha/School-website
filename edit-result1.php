...
$sql="update tblresult1  set marks1=:mrks where id=:iid ";
...
$ret = "SELECT tblstudents.StudentName,tblclasses.ClassName,tblclasses.Section from tblresult1 join tblstudents on tblstudents.StudentId=tblresult1.StudentId join tblsubjects on tblsubjects.id=tblresult1.SubjectId join tblclasses on tblclasses.id=tblresult1.ClassId where tblstudents.StudentId=:stid limit 1";
...
<?php 
$sql = "SELECT distinct tblstudents.StudentName,tblstudents.StudentId,tblclasses.ClassName,tblclasses.Section,tblsubjects.SubjectName,tblresult1.marks1,tblresult1.id as resultid from tblresult1 join tblstudents on tblstudents.StudentId=tblresult1.StudentId join tblsubjects on tblsubjects.id=tblresult1.SubjectId join tblclasses on tblclasses.id=tblresult1.ClassId where tblstudents.StudentId=:stid ";
$query = $dbh->prepare($sql);
...
<input type='number' name="marks1[]" class="form-control" id="marks" min="1" max="100" value=" <?php echo htmlentities($result->marks1)?>" maxlength="3" required="required" placeholder="Enter marks out of 100" autocomplete="off">
